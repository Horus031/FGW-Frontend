...
const TaskContainer = () => {
  ...
  const tasks: Task[] = [
    ...
    { id: 2, status: null, title: 'Submit Dissertation', studentgroup: 'SonND24', course: 'DESI1240.2 - Design Research Project', dueDate: '17 Mar 2025', requirements: ['Cover page', 'Abstract', 'Research findings', 'References'], description: 'Complete and submit the final dissertation document, ensuring all sections are thoroughly researched and well-written. Adhere to the formatting guidelines provided by the university and include all necessary citations and references.' },
